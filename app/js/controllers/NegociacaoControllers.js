System.register(["../views/NegociacoesView", "../views/MensagemView", "../models/Negociacoes", "../models/Negociacao"], function (exports_1, context_1) {
    "use strict";
    var NegociacoesView_1, MensagemView_1, Negociacoes_1, Negociacao_1, NegociacaoControllers;
    ...
    return {
        ...
        execute: function () {
            NegociacaoControllers = class NegociacaoControllers {
                constructor() {
                ...
                adiciona(event) {
                    ...
                    this._negociacoesView.update(this._negociacoes);
                    this._mensagemView.update("Sua Negociação foi adicionada com sucesso!");
                }
            };
            exports_1("NegociacaoControllers", NegociacaoControllers);
        }
    };
});
